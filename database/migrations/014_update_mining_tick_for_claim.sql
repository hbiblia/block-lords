-- =====================================================
-- MODIFICAR process_mining_tick() PARA USAR PENDING_BLOCKS
-- En lugar de acreditar directamente, guarda en pending_blocks
-- =====================================================
...
BEGIN
  ...
  -- ============================================
  -- CAMBIO PRINCIPAL: Guardar en pending_blocks
  -- en lugar de acreditar directamente
  -- ============================================
  INSERT INTO pending_blocks (block_id, player_id, reward)
  VALUES (v_block.id, v_winner_player_id, v_reward);

  -- Actualizar reputación (esto sí se hace inmediatamente)
